...
public class MaterialBarcodeScanner {
    ...
    protected final com.reonios.msco.MaterialBarcodeScannerBuilder mMaterialBarcodeScannerBuilder;

    private FrameLayout mContentView; //Content frame for fragments

    private OnResultListener onResultListener;

    public MaterialBarcodeScanner(@NonNull com.reonios.msco.MaterialBarcodeScannerBuilder materialBarcodeScannerBuilder) {
    ...
    public void startScan(){
        ...
        if (mCameraPermission != PackageManager.PERMISSION_GRANTED) {
            ...
            Intent intent = new Intent(mMaterialBarcodeScannerBuilder.getActivity(), com.reonios.msco.MaterialBarcodeScannerActivity.class);
    ...
    public com.reonios.msco.MaterialBarcodeScannerBuilder getMaterialBarcodeScannerBuilder() {
